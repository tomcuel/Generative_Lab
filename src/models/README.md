...
## Theory (quick)
(more details to see the architecture of each part in the NRT part for the diffusion models : **[NRT_GANs](./../../NRT/NRT_GANs/)**)
...
Training consists of two complementary processes (more details to see the architecture of each part in the NRT part for the diffusion models : **[NRT_diffusion_models](./../../NRT/NRT_diffusion_models/)**)
